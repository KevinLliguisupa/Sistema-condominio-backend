...
CREATE TABLE public.fin_incidencia (
                                       ...
                                       CONSTRAINT fin_incidencia_pk PRIMARY KEY (inc_id, usu_cedula)
);
...
CREATE TABLE public.fin_gastos (
                                   ...
                                   CONSTRAINT fin_gastos_pk PRIMARY KEY (gas_id, inc_id, usu_cedula, tse_id)
);
...
ALTER TABLE public.fin_gastos ADD CONSTRAINT fin_incidencia_fin_gastos_fk
    FOREIGN KEY (inc_id, usu_cedula)
        REFERENCES public.fin_incidencia (inc_id, usu_cedula)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION
        NOT DEFERRABLE;
